...
print(email.lower()) # coloca em letra mínuscula
...
nome = "joao lira"
print(nome.capitalize()) # Joao lira primeira letra maiuscula
print(nome.title()) # Joao Lira primeira letra maiuscula de todas palavras
